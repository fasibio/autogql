...
func (ec *executionContext) unmarshalOSoftDeleteFilterInput2ᚖgithubᚗcomᚋfasibioᚋautogqlᚋtestserviceᚋgraphᚋmodelᚐSoftDeleteFilterInput(ctx context.Context, v interface{}) (*model.SoftDeleteFilterInput, error) {
	if v == nil {
		return nil, nil
	}
